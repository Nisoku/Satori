...
```typescript
import { filterByLevel } from 'satori-log';
...
```typescript
import { filterByScope } from 'satori-log';
...
```typescript
import { filterByTag, filterByTags } from 'satori-log';
...
```typescript
import { filterByTimeRange } from 'satori-log';
...
```typescript
import { filterByState } from 'satori-log';
...
```typescript
import { filterByMessage } from 'satori-log';
...
```typescript
import { filterByCause } from 'satori-log';
